...
<template>
  <div ref="root" class="occurrences">
    <p class="occurrence-count">共 {{ matches.length }} 个上课时段</p>
...
.occurrence { display: grid; gap: 4px; width: 100%; padding: 12px; border: 0; border-radius: 8px; background: transparent; color: var(--text); text-align: left; cursor: pointer; overflow-wrap: anywhere }
.occurrence + .occurrence { border-top: 1px solid var(--border-soft) }
